            ...
            <div class="container ">
                <div class="row">
                    <div class="wpb_column column_container col-md-5">
                        <div class="vc_column-inner wpb_wrapper">
                            <div role="form" class="wpcf7" id="wpcf7-f7467-p8088-o1" lang="en-US" dir="ltr">
                                <div class="screen-reader-response"></div>
                                <form action="/contact/#wpcf7-f7467-p8088-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                                    <div style="display: none;">
                                        <input type="hidden" name="_wpcf7" value="7467">
                                        <input type="hidden" name="_wpcf7_version" value="5.1.6">
                                        <input type="hidden" name="_wpcf7_locale" value="en_US">
                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f7467-p8088-o1">
                                        <input type="hidden" name="_wpcf7_container_post" value="8088">
                                    </div>
                                    <div class="st-contact-form">
                                        ...
                                        <div class="contact-form">
                                            ...
                                            <div class="form-group">
                                                <span class="wpcf7-form-control-wrap your-name"><input type="email" name="your-name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form-control" aria-required="true" aria-invalid="false" placeholder="Email"></span>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <p><input type="submit" value="SEND MESSAGE" class="wpcf7-form-control wpcf7-submit btn btn-primary"><span class="ajax-loader"></span></p>
                                        </div>
                                    </div>
